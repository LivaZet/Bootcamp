...
public class TeacherController {
    ...
    public Teacher findTeacher(@RequestParam Integer id) {
        ...
        Teacher result = manager.findTeacher(id);
        return result;
    }
    ...
    public List<Teacher> findTeacher(@RequestParam String firstName,
        ...
        List<Teacher> result = manager.findTeacher(firstName, lastName);
        return result;
    }
    ...
    public StatusResponse insertTeacher(@RequestParam(required = false) Integer id,
         ...
         */
 //       StatusResponse result = manager.insertTeacher(firstName, lastName);
        return null;
    }
 ...
 //       StatusResponse result = manager.updateTeacher(teacher);
        return null;
    }
